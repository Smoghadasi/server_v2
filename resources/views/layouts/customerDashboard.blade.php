...
<head>
    ...
    <link href="{{ asset("css/dashboard-style-v1.css") }}" rel="stylesheet"/>
...
<div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{ url('user/getCustomerLoadsList') }}">
                <i class="fas fa-fw fa-truck-loading"></i>
                <span>بارهای ثبت شده من</span>
            </a>
        </li>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{ url('user/userCriticismOrComplaints') }}">
                <i class="fas fa-fw fa-paper-plane"></i>
                <span>انتقاد یا شکایت</span>
            </a>
        </li>
