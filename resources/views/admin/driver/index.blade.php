    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="col-md-12 mb-3">
                <a class="btn btn-primary" href="{{ route('driver.create') }}"> + افزودن راننده</a>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-primary"
                                   href="{{ route('driver.show', $driver->id) }}">جزئیات</a>
                                <a class="btn btn-sm btn-success"
                                   href="{{ route('driver.edit', $driver->id) }}">ویرایش</a>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>آیا مایل به حذف راننده
                                                        <span
                                                            class="text-primary"> {{ $driver->name }}{{ $driver->lastName }}</span>
                                                        هستید؟</p>
                                                </div>
                                                <div class="modal-footer text-left">
                                                    <form action="{{ route('driver.destroy', $driver->id) }}" method="post">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="submit" class="btn btn-primary">حذف راننده</button>
                                                    </form>
                                                    <button type="button" class="btn btn-danger"
                                                            data-bs-dismiss="modal">
                                                        انصراف
