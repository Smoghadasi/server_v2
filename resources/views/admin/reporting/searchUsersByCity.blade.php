...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('reporting.searchUsersByCity') }}" method="post">
                @csrf
                    ...
                    <tbody>
                        @foreach ($users as  $key => $user)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('reporting.usersByCustomCities', $user->city_id) }}">
                                        {{ $user->cityOwner->state }} - {{ $user->cityOwner->name }}
                                    </a>
                                </td>
                                <td>{{ $user->count }}</td>
                            </tr>
