...
@section('content')
    ...
    <div class="card">
        <h5 class="card-header">
            ...
            <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addService"> + گزارش گیری
            </button>
            <div id="addService" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <form method="post" enctype="multipart/form-data" action="{{ route('view-pdf') }}"
                        class="modal-content">
                        @csrf
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="from" class="form-control" placeholder="YY / MM / DD" />
                            </div>
                            <div class="form-group mt-2">
                                <label class="form-label">تا :</label>
                                <input type="text" name="to" class="form-control" placeholder="YY / MM / DD" />
                            </div>
        ...
        <div class="card-body">
            ...
            <div class="col-lg-12 m-2 mb-3 text-right">
                <a href="{{ url('admin/paymentReport') }}/{{ ROLE_DRIVER }}/100" class="alert p-1 alert-success">تعداد
                    پرداخت
                    موفق : {{ number_format($counter['success']) }}</a>
                <a href="{{ url('admin/paymentReport') }}/{{ ROLE_DRIVER }}/0" class="alert p-1 alert-danger">تعداد پرداخت
                    نا
                                    ...
                                    <td>
                                        ...
                                        @elseif($transaction->status == 100 || $transaction->status == 101)
                                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip"
                                                title="دسترسی فقط پرداخت ناموفق">
                                                <button class="btn btn-primary btn-sm" style="pointer-events: none;"
                                                    type="button" disabled>تمدید اعتبار</button>
                                            </span>
                                        @endif
                                    </td>
                                </tr>
