    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tr>
                    <th class="text-center"> باربری ها</th>
                ...
                <tr>
                    ...
                    <td>تعداد کل : {{ number_format($transportationCompanies['total']) }}</td>
                ...
                <tr>
                    ...
                    <td>افزایش امروز : {{ number_format($transportationCompanies['toDay']) }}</td>
                ...
                <tr>
                    ...
                    <td>افزایش دیروز : {{ number_format($transportationCompanies['yesterday']) }}</td>
                ...
                <tr>
                    ...
                    <td>افزایش طی هفته : {{ number_format($transportationCompanies['week']) }}</td>
                ...
                <tr>
                    <td></td>
                    <td>تعداد بار ثبت شده امروز : {{ number_format($transportationCompanies['toDayLoads']) }}</td>
                ...
                <tr>
                    <td></td>
                    <td>تعداد بار ثبت شده دیروز : {{ number_format($transportationCompanies['yesterdayLoads']) }}</td>
                ...
                <tr>
                    <td></td>
                    <td> بار ثبت شده هفته : {{ number_format($transportationCompanies['weekLoads']) }}</td>
                ...
                <tr>
                    ...
                    <td colspan="2" class="text-center">
                        بار ثبت شده دیروز :
                        {{ number_format($transportationCompanies['yesterdayLoads'] + $cargoOwners['yesterdayLoads']) }}
                    </td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td colspan="3" class="text-center h4">
                        جمع کل بارهای دیروز :
                        {{ number_format($transportationCompanies['yesterdayLoads'] + $cargoOwners['yesterdayLoads']+$operators['yesterdayLoads']) }}
                    </td>
                    <td></td>
                </tr>
            </table>
