    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex align-items-start align-items-sm-center gap-4">
              <img
                src="{{ asset('assets/img/truck-driver.jpg') }}"
                alt="user-avatar"
            ...
            <form>
              <div class="row">
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <input class="form-control" type="text" name="lastName" id="lastName" value="{{ $driver->lastName }}" disabled />
                </div>
                <div class="mb-3 col-md-6">
