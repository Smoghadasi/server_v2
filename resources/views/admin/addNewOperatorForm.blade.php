    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('admin/addNewOperator') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label for="mobileNumber" class="col-md-4 col-form-label text-md-right">شماره موبایل</label>
                ...
                <div class="form-group row">
                    <label for="sex" class="col-md-4 col-form-label text-md-right">جنسیت</label>
                ...
                <div class="form-group row">
                    <label for="sex" class="col-md-4 col-form-label text-md-right">نوع کاربر</label>
                ...
                <div class="form-group row">
                    <label for="password-confirm"
                           class="col-md-4 col-form-label text-md-right">تکرار رمز ورود</label>
                ...
                <div class="form-group row text-right">
                    <label for="pic" class="col-md-4 col-form-label text-md-right">تصویر اپراتور</label>
                    <div class="col-md-6">
