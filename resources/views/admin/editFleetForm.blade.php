...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('admin/editFleet') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-6">
                        <select name="parent_id" class="form-control">
                            ...
                            @foreach($fleetParents as $fleetParent)
                                <option value="{{ $fleetParent->id }}"
                                        @if($fleetParent->id == $fleet->parent_id)
                                        selected
                                    @endif
                ...
                <div class="form-group row m-2">
                    ...
                    <div class="col-md-6">
                        <input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}"
                               name="title" value="{{ $fleet->title }}" required autofocus>
                ...
                <div class="form-group row text-right m-2">
                    <label for="pic" class="col-md-4 col-form-label text-md-right">{{ __('تصویر جدید نوع ناوگان') }}</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row text-right m-2">
                    ...
                    <img src="{{ url($fleet->pic) }}" width="128" height="128">
                </div>
