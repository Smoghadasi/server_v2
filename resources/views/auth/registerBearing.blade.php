                        ...
                        <form method="POST" action="{{ url('user/registerBearing') }}">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="title"
                                           class="col-md-12 col-form-label text-md-right">{{ __('عنوان باربری : ') }}</label>
                                    <div class="col-md-12">
                                        <input id="title" type="text"
                                               class="col-md-12 form-control{{ $errors->has('title') ? ' is-invalid' : '' }}"
                                               name="title" value="{{ old('title') }}"
                                               placeholder="عنوان باربری" required autofocus>
                                        @if ($errors->has('title'))
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="registrationNumber"
                                           class="col-md-12 col-form-label text-md-right">{{ __('شناسه ثبت باربری : ') }}</label>
                                    <div class="col-md-12">
                                        <input id="registrationNumber" type="tel"
                                               ...
                                               placeholder="شناسه ثبت باربری" required autofocus>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="city"
                                           class="col-md-12 col-form-label text-md-right">{{ __('شهر باربری : ') }}</label>
                                    <div class="col-md-12">
                                        <select id="city"
